...
set_property PACKAGE_PIN H17 [get_ports {o_retrans_wait}]
...
set_property PACKAGE_PIN V17 [get_ports {o_rt_state[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_rt_state[0]}]
set_property PACKAGE_PIN U17 [get_ports {o_rt_state[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_rt_state[1]}]
set_property PACKAGE_PIN U16 [get_ports {o_rt_state[2]}]
...
set_property PACKAGE_PIN V14 [get_ports {o_tr_state[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_tr_state[0]}]
set_property PACKAGE_PIN V12 [get_ports {o_tr_state[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_tr_state[1]}]
set_property PACKAGE_PIN V11 [get_ports {o_tr_state[2]}]
